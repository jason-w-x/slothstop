    ...
    def median_filter(self):
        ...
        for speed in self.wspd:
            ...
            if iAPRS > 0 and iAPRS < len(self.wspd) - 1:
                if (self.wspd[iAPRS - 1] > self.wspd[iAPRS] and self.wspd[iAPRS - 1] < self.wspd[iARPS + 1]) or (self.wspd[iAPRS - 1] < self.wspd[iAPRS] and self.wspd[iAPRS - 1] > self.wspd[iAPRS + 1]):
                    iMedian = iAPRS - 1

                if (self.wspd[iAPRS + 1] > self.wspd[iAPRS] and self.wspd[iAPRS + 1] < self.wspd[iAPRS - 1]) or (self.wspd[iAPRS + 1] < self.wspd[iAPRS] and self.wspd[iAPRS + 1] > self.wspd[iAPRS - 1]):
                    iMedian = iAPRS + 1
            
            self.vnor[iAPRS] = self.vnor[iMedian]
            self.veas[iAPRS] = self.veas[iMedian]
